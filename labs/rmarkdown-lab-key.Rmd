...
8. Check out the docs at: http://rmarkdown.rstudio.com/ and look under formats. See if you can create and compile an R markdown presentation. 

9. Add the command devtools::session_info() to this chunk and look at the output
